...
<%@ page
	import="com.banque.Dao.*,com.banque.entities.*,com.banque.Util.*,java.util.*"
	isErrorPage="false"%>
...
<!-- Zebraaa date picker-->
<link rel="stylesheet"
	href="vendor/bootstrap/css/zebra_datepicker.min.css" type="text/css">
		...
		<div id="wrapper">
			...
			<ul class="sidebar navbar-nav">
				...
				<li class="nav-item dropdown"><a
					...
					role="button" data-toggle="dropdown" aria-haspopup="true"
					aria-expanded="false"> <i class="fas fa-fw fa-folder"></i> <span>Comptes</span></a>
					<div class="dropdown-menu dropdown-menu-right"
						aria-labelledby="userDropdown">
						<a class="dropdown-item" href="ajouterCompte.jsp">Ajouter</a> <a
							class="dropdown-item" href="listercompte.jsp">Lister</a>
				...
				<li class="nav-item dropdown"><a
					class="nav-link dropdown-toggle" href="#" id="pagesDropdown"
					role="button" data-toggle="dropdown" aria-haspopup="true"
					aria-expanded="false"> <i class="fas fa-fw fa-folder"></i> <span>Operation</span></a>
					<div class="dropdown-menu dropdown-menu-right"
						aria-labelledby="userDropdown">

						<a class="dropdown-item" href="listeoperation.jsp">Lister</a>
					</div></li>
				<li class="nav-item dropdown"><a
					class="nav-link dropdown-toggle" href="#" id="pagesDropdown"
					role="button" data-toggle="dropdown" aria-haspopup="true"
					aria-expanded="false"> <i class="fas fa-fw fa-folder"></i> <span>Clients</span></a>
					<div class="dropdown-menu dropdown-menu-right"
						aria-labelledby="userDropdown">
						<a class="dropdown-item" href="ajouterclient.html">Ajouter</a> <a
							class="dropdown-item" href="listeclients.jsp">Lister</a>
			...
			<div id="content-wrapper">
				...
				<div class="container-fluid">
					...
					<div id="page-wrapper" align="center">
						<div class="row">
							<div class="col-lg-12">
								<h1 class="page-header">AJOUTER UN COMPTE</h1>
							</div>
							<!-- /.col-lg-12 -->
						</div>
						<!-- /.row -->
													...
													<div id="client_nom">
														...
														<label>CLIENTS:</label> <select class="form-control"
															...
															<div class="alert alert-danger text-center">
																<h2>
																	<strong>Attention!</strong></strong> Aucun client n'est
